...
namespace CompilerSample
{
    public class LanguageGrammar<TValue> : Grammar<char>
    {
        ...
        Terminal<char> Plus = new Terminal<char> { Name = "+", InitialState = TerminalClassifier.GetLiteralMatcher("+") };
        Terminal<char> Minus = new Terminal<char> { Name = "-", InitialState = TerminalClassifier.GetLiteralMatcher("-") };
        Terminal<char> Star = new Terminal<char> { Name = "*", InitialState = TerminalClassifier.GetLiteralMatcher("*") };
        Terminal<char> Slash = new Terminal<char> { Name = "/", InitialState = TerminalClassifier.GetLiteralMatcher("/") };
        Terminal<char> Percent = TerminalClassifier.GetLiteralToken("%", "%");
        Terminal<char> Bang = TerminalClassifier.GetLiteralToken("!", "!");
        Terminal<char> Caret = TerminalClassifier.GetLiteralToken("^", "^");
        Terminal<char> Equal = TerminalClassifier.GetLiteralToken("=", "=");
        Terminal<char> LeftParen = new Terminal<char> { Name = "(", InitialState = TerminalClassifier.GetLiteralMatcher("(") };
        Terminal<char> RightParen = new Terminal<char> { Name = ")", InitialState = TerminalClassifier.GetLiteralMatcher(")") };
        Terminal<char> Comma = new Terminal<char> { Name = ",", InitialState = TerminalClassifier.GetLiteralMatcher(",") };
        Terminal<char> Dot = TerminalClassifier.GetLiteralToken(".", ".");
        Terminal<char> LeftBracket = new Terminal<char> { Name = "[", InitialState = TerminalClassifier.GetLiteralMatcher("[") };
        Terminal<char> RightBracket = TerminalClassifier.GetLiteralToken("]", "]");
        Terminal<char> LeftAngleBracket = TerminalClassifier.GetLiteralToken("<", "<");
        Terminal<char> RightAngleBracket = TerminalClassifier.GetLiteralToken(">", ">");
        Terminal<char> LeftBrace = TerminalClassifier.GetLiteralToken("{", "{");
        Terminal<char> RightBrace = TerminalClassifier.GetLiteralToken("}", "}");
        Terminal<char> Ampersand = TerminalClassifier.GetLiteralToken("&", "&");
        Terminal<char> Pipe = TerminalClassifier.GetLiteralToken("|", "|");
        Terminal<char> BooleanAnd = TerminalClassifier.GetLiteralToken("&&", "&&");
        Terminal<char> BooleanOr = TerminalClassifier.GetLiteralToken("||", "||");
